...
<input type="text" name="returnCode" id="returnCode" style="display:none">
      ...
      <div class="mode style-3">
        ...
        <ul>
          ...
          <li>若您已有台灣就業通網站帳號，可點選下方登入，頁面將引導至台灣就業通網站進行登入。</li>
          <li>
...
<script src="js/paymentLogin/paymentLogin.js"></script>
<script src="js/paymentLogin/CaCheck.js"></script>
<script src="js/paymentLogin/errorcode.js"></script>
</body>
</html>