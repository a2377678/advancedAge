...
<script src="js/schedule_teach_payment/schedule_teach_payment.js"></script>
</head>
<style type="text/css">
	@page {
    ...
    <div class="apply_main">
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">僱用退休中高齡者及高齡者傳承專業技術及經驗補助計畫 - 請領進度</li>
        </ol>
      </nav>
      <h1>僱用退休中高齡者及高齡者傳承專業技術及經驗補助計畫 - 請領進度</h1>
      <h2>申請流程：請領查詢</h2>
      ...
      <div>
      	<c:if test="${not empty base.allowanceFileStatusRecord}">
	        ...
	        <div class="fs-5 fw-bolder py-2 mb-3">請領查詢：
	          <c:if test="${base.caseStatus==5 }"><span class="text-danger">本次請領審核中</span></c:if>
	          <c:if test="${base.caseStatus==6 }"><span class="text-danger">本次請領不合格</span></c:if>
	          <c:if test="${base.caseStatus==7}"><span class="text-info">本次請領已核定</span></c:if>
	        </div>
        </c:if>
      ...
      <div class="form">
        ...
        <div>聯絡電話：${result.contactWorkPhoneAreaCode } - ${result.contactWorkPhone } #${result.contactWorkPhoneExtension }</div>
      ...
      <div class="form">
        ...
        <div class="full"><b>本計畫核准函影本：</b><br>
        ...
        <div class="full"><b>成果報告之內容附件：</b><br>
        ...
        <div class="full"><b>經費支用單據正本及明細表：</b><br>
        ...
        <div class="full"><b>內聘講師鐘點費印領清冊：</b><br>
