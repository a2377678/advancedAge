...
<script src="js/teach_payment_04/teach_payment_04.js"></script>
</head>
<style type="text/css">
	@page {
...
<div class=""> 
  ...
  <%@ include file="countDownComponent.jsp" %>
      ...
      <div class="form">
        ...
        <div class="full lh-lg"><span class="title-c">辦理情形：</span><br>
        	${result.planExecutionSituation.replace("\\n","<br>") }
        </div>
        <div class="full lh-lg"><span class="title-c">實施成果：</span><br>
        	${result.result.replace("\\n","<br>") }
        </div>
        <div class="full lh-lg"><span class="title-c">檢討與建議：</span><br>
      ...
      <div class="form">
        ...
        <div class="full lh-lg"><span class="title-c">內聘講師鐘點費印領清冊：</span><br>
	  ...
	  <!--endprint-->
      <div class="page">
        <button onclick="javascript:location.href='teach_payment_03'">返回修改</button>
