...
<div class=""> 
  ...
  <div class="main clearfix" id="content"> 
	...
	<!--endprint-->
      <div class="page">
        <button onclick="javascript:location.href='career_payment_03'">返回修改</button>
        <button onclick="doPrint()">列印資料</button>
        <button class="sendcase" onclick="finish()">送出請領資料</button>
      </div>
    </div>
    <!------------ 申請流程 END ------------> 
...
<script src="js/career_payment_04/career_payment_04.js"></script>
</body>
</html>