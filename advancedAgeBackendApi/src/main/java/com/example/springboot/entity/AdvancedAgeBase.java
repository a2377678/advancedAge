...
public class AdvancedAgeBase implements Serializable {
    ...
    private String allowanceApprovedId;

    private String allowanceApprovedTime;
    ...
    public String getAllowanceApprovedId() {
        return allowanceApprovedId;
    }

    public void setAllowanceApprovedId(String allowanceApprovedId) {
        this.allowanceApprovedId = allowanceApprovedId == null ? null : allowanceApprovedId.trim();
    }

    public String getAllowanceApprovedTime() {
        return allowanceApprovedTime;
    }

    public void setAllowanceApprovedTime(String allowanceApprovedTime) {
        this.allowanceApprovedTime = allowanceApprovedTime == null ? null : allowanceApprovedTime.trim();
    }
