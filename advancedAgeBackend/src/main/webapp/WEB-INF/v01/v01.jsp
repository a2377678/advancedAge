...
<script type="text/javascript" src="js/v01/v01.js"></script>
...
<body>
  ...
  <div id="main">
    ...
    <div id="content">
	  ...
	  <c:if test="${functionPermission3.indexOf('V01')!=-1 }">
      <!------------------- search ------------------->
      <form action="v01" method="post" id="searchForm">
      <div id="search_bar">
      ...
      <form action="v01_1" method="post" id="dataForm">
      ...
      <c:if test="${functionPermission3.indexOf('V01')==-1 }"><p>無此權限</p></c:if>
