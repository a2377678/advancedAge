...
<body>
  ...
  <div id="main">
    ...
    <div id="content">
      ...
      <!------------------- table 1 ------------------->
        <div id="page_tab">
          <div class="tab-1"><a href="w02">查詢 / 修改紀錄</a></div>
          <div class="tab-1"><a href="w02_02" class="in">實地查核登錄</a></div>
          <div class="tab-1"><a href="/file/SAMPLE/退休再就業_查核計畫.docx">訪視表單下載</a></div>
        </div>
      
      
      <!------------------- search ------------------->
      <form action="w02_02" method="post">
      <div id="search_bar">
  ...
  <script src="js/w02/w02_02.js"></script>
