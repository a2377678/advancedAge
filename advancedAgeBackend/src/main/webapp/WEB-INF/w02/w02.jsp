  ...
  <div id="main">
    ...
    <div id="content">
      ...
      <div id="account">
		...
		<c:if test="${functionPermission3.indexOf('W02')!=-1 }">
<%--       <%if(String.valueOf(session.getAttribute("functionPermission")).indexOf("B04")!=-1){ %> --%>
      ...
      <!------------------- search ------------------->
      <form action="w02" method="post" id="searchForm">
      <div id="search_bar">
      ...
      <form action="w02_1" method="post" id="dataForm">
      ...
      <c:if test="${functionPermission3.indexOf('W02')==-1 }"><p>無此權限</p></c:if>
  ...
  <script src="js/w02/w02.js"></script>
