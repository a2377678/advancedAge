...
<script type="text/javascript" src="js/o01/o01.js"></script>
</head>
...
<body>
  ...
  <div id="main">
    ...
    <div id="content">
      <div id="main_title">案件查核管理
        <span>停止補助名單</span>
        <span id="number">O01</span>
      </div>
	  ...
	  <c:if test="${functionPermission2.indexOf('O01')!=-1 }">
      <!------------------- table 1 ------------------->
        <div id="page_tab">
      ...
      <!------------------- search ------------------->
      <form action="o01" method="post" id="searchForm">
      <div id="search_bar">
      ...
      <form action="o01_1" method="post" id="dataForm">
      ...
      <c:if test="${functionPermission2.indexOf('O01')==-1 }"><p>無此權限</p></c:if>
