...
<script type="text/javascript" src="js/o01/o01_02.js"></script>
...
<body>
  ...
  <div id="main">
    ...
    <div id="content">
      ...
      <!------------------- table 1 ------------------->
        <div id="page_tab">
          <div class="tab-1"><a href="o01">查詢 / 修改紀錄</a></div>
          <div class="tab-1"><a href="o01_02" class="in">停止補助名單登錄</a></div>
        </div>
      
      
      <!------------------- search ------------------->
      <form action="o01_02" method="post">
      <div id="search_bar">
