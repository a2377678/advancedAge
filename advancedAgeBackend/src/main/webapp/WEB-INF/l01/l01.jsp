...
<script type="text/javascript" src="js/l01/l01.js"></script>
</head>
...
<body>
  ...
  <div id="main">
    ...
    <div id="content">
      ...
      <!------------------- search ------------------->
      <c:if test="${functionPermission2.indexOf('L01')!=-1 }">
      <form action="l01" method="post" id="searchForm">
      ...
      <form action="l01File" method="post" id="dataForm" target="_blank">
    ...
    <c:if test="${functionPermission2.indexOf('L01')==-1 }"><p>無此權限</p></c:if>
