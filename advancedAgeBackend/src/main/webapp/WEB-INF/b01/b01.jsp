	      	...
	      	<c:when test="${not empty baseList}">
		      	<c:forEach items="${baseList}" var="item" varStatus="status">
		      		<c:if test="${item.fileStatus==4 }">
				          ...
				          <c:if test="${item.fileStatus=='4' && item.caseStatus<4}">,'b02_1'</c:if>
				          <c:if test="${item.fileStatus=='4' && (item.caseStatus==4 || item.caseStatus==8) }">,'b05_1'</c:if>
				          <c:if test="${item.fileStatus=='4' && item.caseStatus>4 && item.caseStatus<8}">,'c01_1'</c:if>)">
