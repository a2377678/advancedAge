...
<script type="text/javascript" src="js/q05/q05.js"></script>
</head>
  ...
  <div id="main">
    ...
    <div id="content">
      ...
      <div id="account">
		...
		<c:if test="${functionPermission2.indexOf('Q05')!=-1 }">
      <!------------------- search ------------------->
      <form action="q05" method="post" id="searchForm">
      	<div id="search_bar">
    ...
    <c:if test="${functionPermission2.indexOf('Q05')==-1 }"><p>無此權限</p></c:if>
