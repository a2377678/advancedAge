...
<body>
  ...
  <div id="main">
    ...
    <div id="content">
      ...
      <!------------------- search ------------------->
      <c:if test="${functionPermission3.indexOf('T01')!=-1 }">
      <form action="t01" method="post" id="searchForm">
      ...
      <c:if test="${functionPermission3.indexOf('T01')==-1 }"><p>無此權限</p></c:if>  
...
<script src="js/t01/t01.js"></script>
