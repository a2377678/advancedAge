...
<script type="text/javascript" src="js/m02/m02.js"></script>
</head>
...
<body>
  ...
  <div id="main">
    ...
    <div id="content">
	  ...
	  <c:if test="${functionPermission2.indexOf('M02')!=-1 }">
      <!------------------- search ------------------->
      <form action="m02" method="post" id="searchForm">
      <div id="search_bar">
      ...
      <form action="m02_1" method="post" id="dataForm">
    ...
    <c:if test="${functionPermission2.indexOf('M02')==-1 }"><p>無此權限</p></c:if>
