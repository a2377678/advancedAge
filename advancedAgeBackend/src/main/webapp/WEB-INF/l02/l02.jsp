...
<script type="text/javascript" src="js/l02/l02.js"></script>
</head>
...
<!---------------------- top ---------------------->
  ...
  <div id="main">
    ...
    <div id="content">
      ...
      <!------------------- search ------------------->
      <c:if test="${functionPermission2.indexOf('L02')!=-1 }">
      <form action="l02" method="post" id="searchForm">
    ...
    <c:if test="${functionPermission2.indexOf('L02')==-1 }"><p>無此權限</p></c:if>
