...
<script type="text/javascript" src="js/y02/y02.js"></script>
</head>
...
<!---------------------- left menu end ---------------------->
  ...
  <div id="main">
    ...
    <div id="content">
      ...
      <c:if test="${functionPermission3.indexOf('Y02')!=-1 }">
		<!------------------- search ------------------->
		<form action="y02" method="post" id="searchForm">
	      <div id="search_bar">
        ...
        <table class="table_04">
          <tr>
            ...
            <th>申請單位</th>
            <th>行業別</th>
            <th style="width: 25%;">退休後再就業準備受益人數</th>
          </tr>
          <c:choose>
	          <c:when test="${not empty caseStatisticsList}">
    ...
    <c:if test="${functionPermission3.indexOf('Y02')==-1 }"><p>無此權限</p></c:if>
    </div>
