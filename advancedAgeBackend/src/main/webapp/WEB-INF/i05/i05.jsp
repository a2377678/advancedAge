...
<script type="text/javascript" src="js/i05/i05.js"></script>
</head>
...
<body>
  ...
  <div id="main">
    ...
    <div id="content">
      ...
      <c:if test="${functionPermission.indexOf('I05')!=-1 }">
      <!------------------- search ------------------->
        <form action="i05" method="post" id="searchForm">
		<div id="search_bar">
    ...
    <c:if test="${functionPermission.indexOf('I05')==-1 }"><p>無此權限</p></c:if>
