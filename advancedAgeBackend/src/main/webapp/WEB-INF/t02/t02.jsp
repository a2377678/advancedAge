...
<body>
  ...
  <div id="main">
    ...
    <div id="content">
      ...
      <!------------------- search ------------------->
      <c:if test="${functionPermission3.indexOf('T02')!=-1 }">
      <form action="t02" method="post" id="searchForm">
      ...
      <form action="t01File" method="post" id="dataForm" target="_blank">
    ...
    <c:if test="${functionPermission3.indexOf('T02')==-1 }"><p>無此權限</p></c:if>  
...
<script src="js/t02/t02.js"></script>
