...
<body>
  ...
  <div id="main">
    ...
    <div id="content">
      ...
      <form action="z02" method="post" id="searchForm">
	      <div id="search_bar">
	        <table class="table_01">
	            ...
	            <td width="2%">
		            <select name="unit" id="unit">
			            ...
			            <c:forEach  items="${unitList}"  var="item"  varStatus="userStatus">
					      <option value="${item.id}" <c:if test="${searchUserInfo.unit==item.id}">selected</c:if> >${item.name}</option>
					    </c:forEach>
		            </select>
	            </td>
	            <th width="14%">權限群組：</th>
	          ...
	          <tr>
	            <th>使用者帳號：</th>
	            <td>
	            	<input type="text" size="11" id="userAccount" name="userAccount" value="${searchUserInfo.account}"/>
	            </td>
	            <th>使用者姓名：</th>
	            <td>
	            	<input type="text" size="11" id="name" name="name" value="${searchUserInfo.name}"/>
	            </td>
	            <td colspan="2">
      ...
      <table class="table_07">
        ...
        <c:choose>
        <c:when test="${not empty userInfoData}">
...
　　　　 <br />
      ...
      <form action="z02_1" method="post" id="dataForm">
...
<script src="js/z02/z02.js"></script>
