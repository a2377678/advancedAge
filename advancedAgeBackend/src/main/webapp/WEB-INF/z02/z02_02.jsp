...
<body>
  ...
  <div id="main">
    ...
    <div id="content">
      ...
      <!------------------- search ------------------->
      <div id="page_tab">
        <div class="tab-1"><a href="z02">查詢／修改</a></div>
        <div class="tab-1"><a href="z02_02" class="in">新建帳號</a></div>
      </div>
      <form action="z02_02" method="post" id="addForm">
...
<script src="js/z02/z02_02.js"></script>
