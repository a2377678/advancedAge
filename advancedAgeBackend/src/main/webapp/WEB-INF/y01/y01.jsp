...
<body>
  ...
  <!---------------------- main ---------------------->
  <div class="chart_index clearfix">

    <!--------- 繼續雇用 --------->
    <div class="chart_box-1">
      <div class="chart_title-1">繼續僱用高齡者</div>
      ...
      <!--------- 圓餅圖 --------->
      <div style="width:380px; height:300px; margin-left:15px; padding-bottom:30px;">
    ...
    <div class="chart_box-3">
      ...
      <div class="chart_title-s5">再就業協助人數</div>
    </div>
