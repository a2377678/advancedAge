...
<script type="text/javascript" src="js/r02/r02_02.js"></script>
</head>
...
<body>
  ...
  <div id="main">
	...
	<c:if test="${jurisdiction==1 }">
      <!------------------- search ------------------->
      <div id="page_tab">
        <div class="tab-1"><a href="r02">查詢／修改</a></div>
        <div class="tab-1"><a href="r02_02" class="in">新建帳號</a></div>
      </div>
      <form action="r02_02" method="post" id="addForm">
