...
<script type="text/javascript" src="js/r02/r02.js"></script>
</head>
...
<body>
  ...
  <div id="main">
    ...
    <div id="content">
      ...
      <!------------------- search ------------------->
      <div id="page_tab">
        <div class="tab-1"><a href="r02" class="in">查詢／修改</a></div>
        <div class="tab-1"><a href="r02_02">新建帳號</a></div>
      </div>
      <form action="r02" method="post" id="searchForm">
      <div id="search_bar">
...
　　　　 <br />
      ...
      <form action="r02_1" method="post" id="dataForm">
