...
<script type="text/javascript" src="js/q02/q02.js"></script>
</head>
...
<body>
  ...
  <div id="main">
    ...
    <div id="content">
      ...
      <c:if test="${functionPermission2.indexOf('Q02')!=-1 }">
		<!------------------- search ------------------->
		<form action="q02" method="post" id="searchForm">
	      <div id="search_bar">
        ...
        <table class="table_04">
          <tr>
            ...
            <th>申請單位</th>
            <th>行業別</th>
            <th style="width: 25%;">申請傳承經驗講師人數</th>
          </tr>
    ...
    <c:if test="${functionPermission2.indexOf('Q02')==-1 }"><p>無此權限</p></c:if>
    </div>
