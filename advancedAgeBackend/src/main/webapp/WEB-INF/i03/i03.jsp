...
<script type="text/javascript" src="js/i03/i03.js"></script>
</head>
...
<body>
  ...
  <div id="main">
    ...
    <div id="content">
      ...
      <c:if test="${functionPermission.indexOf('I03')!=-1 }">
		<!------------------- search ------------------->
		<form action="i03" method="post" id="searchForm">
      	<div id="search_bar">
    ...
    <c:if test="${functionPermission.indexOf('I03')==-1 }"><p>無此權限</p></c:if>
