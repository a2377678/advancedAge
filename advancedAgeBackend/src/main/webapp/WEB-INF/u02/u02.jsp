...
<script type="text/javascript" src="js/u02/u02.js"></script>
</head>
...
<body>
  ...
  <div id="main">
    ...
    <div id="content">
	  ...
	  <c:if test="${functionPermission3.indexOf('U02')!=-1 }">
      <!------------------- search ------------------->
      <form action="u02" method="post" id="searchForm">
      <div id="search_bar">
      ...
      <form action="u02_1" method="post" id="dataForm">
    ...
    <c:if test="${functionPermission3.indexOf('U02')==-1 }"><p>無此權限</p></c:if>  
