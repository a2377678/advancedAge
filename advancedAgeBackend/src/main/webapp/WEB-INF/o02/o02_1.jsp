...
<script type="text/javascript" src="js/o02/o02_1.js"></script>
...
<body>
  ...
  <div id="main">
    ...
    <div id="content">
      ...
      <input type="button" class="btn_02" value="取消" onclick="location.href='o02'"/>
      </div>
      <br><br><br>
    </form>
