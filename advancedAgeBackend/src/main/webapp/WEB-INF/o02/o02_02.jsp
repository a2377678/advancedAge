...
<script type="text/javascript" src="js/o02/o02_02.js"></script>
...
<body>
  ...
  <div id="main">
    ...
    <div id="content">
      ...
      <!------------------- table 1 ------------------->
        <div id="page_tab">
          <div class="tab-1"><a href="o02">查詢 / 修改紀錄</a></div>
          <div class="tab-1"><a href="o02_02" class="in">實地查核登錄</a></div>
          <div class="tab-1"><a href="/file/SAMPLE/傳承經驗_查核計畫.docx">訪視表單下載</a></div>
        </div>
      
      
      <!------------------- search ------------------->
      <form action="o02_02" method="post">
      <div id="search_bar">
      ...
      <input type="text" id="unit" value="${unit}" style="display:none">
