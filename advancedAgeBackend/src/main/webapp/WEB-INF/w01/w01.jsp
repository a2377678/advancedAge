...
<body>
  ...
  <div id="main">
    ...
    <div id="content">
	  ...
	  <c:if test="${functionPermission3.indexOf('W01')!=-1 }">
      <!------------------- table 1 ------------------->
        <div id="page_tab">
          <div class="tab-1"><a href="w01" class="in">查詢 / 修改紀錄</a></div>
          <div class="tab-1"><a href="w01_02">停止補助名單登錄</a></div>
        </div>
      
      
      <!------------------- search ------------------->
      <form action="w01" method="post" id="searchForm">
      <div id="search_bar">
        <table class="table_01">
          <tr>
            <th width="20%">統一編號 / 扣繳編號：</th>
            <td width="20%"><input type="text" size="11" id="seq" name="seq" value="${blackList.seq}"></td>
            <th width="12%">禁止起始日：</th>
            <td><input type="text" id="banStartDate" name="banStartDate" value="${blackList.banStartDate}" size="20"></td>
            <td width="22%">&nbsp;</td>
          </tr>
          <tr>
            <th>承辦單位 / 行政區：</th>
      ...
      <div class="audit_list">
        ...
        <div class="title">
          <span class="no"></span>
          <span class="update_time">起始日</span>
          <span class="update_time">結束日</span>
      ...
      <ol>
        <c:choose><c:when test="${not empty blackListData}">
      	<c:forEach items="${blackListData}" var="item" varStatus="status">
	          ...
	          <span class="update_time">${item.banStartDate}</span>
	          <span class="update_time">${item.banEndDate}</span>
      ...
      <form action="w01_1" method="post" id="dataForm">
      ...
      <c:if test="${functionPermission3.indexOf('W01')==-1 }"><p>無此權限</p></c:if>
...
<script src="js/w01/w01.js"></script>
