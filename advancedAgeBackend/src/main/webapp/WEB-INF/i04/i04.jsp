...
<script type="text/javascript" src="js/i04/i04.js"></script>
</head>
...
<body>
  ...
  <div id="main">
    ...
    <div id="content">
      ...
      <c:if test="${functionPermission.indexOf('I04')!=-1 }">
		<!------------------- search ------------------->
		<form action="i04" method="post" id="searchForm">
	      <div id="search_bar">
    ...
    <c:if test="${functionPermission.indexOf('I04')==-1 }"><p>無此權限</p></c:if>
