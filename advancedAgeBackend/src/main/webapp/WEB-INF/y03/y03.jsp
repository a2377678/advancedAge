...
<script type="text/javascript" src="js/y03/y03.js"></script>
</head>
...
<!---------------------- left menu end ---------------------->
  ...
  <div id="main">
    ...
    <div id="content">
      ...
      <c:if test="${functionPermission3.indexOf('Y03')!=-1 }">
      	<!------------------- search ------------------->
		<form action="y03" method="post" id="searchForm">
      	<div id="search_bar">
    ...
    <c:if test="${functionPermission3.indexOf('Y03')==-1 }"><p>無此權限</p></c:if>
    </div>
