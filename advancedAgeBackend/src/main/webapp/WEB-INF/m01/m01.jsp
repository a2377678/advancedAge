...
<script type="text/javascript" src="js/m01/m01.js"></script>
</head>
...
<body>
  ...
  <div id="main">
    ...
    <div id="content">
      ...
      <!------------------- search ------------------->
      <c:if test="${functionPermission2.indexOf('M01')!=-1 }">
      <form action="m01" method="post" id="searchForm">
	...
	<c:if test="${functionPermission2.indexOf('M01')==-1 }"><p>無此權限</p></c:if>
    </div>
