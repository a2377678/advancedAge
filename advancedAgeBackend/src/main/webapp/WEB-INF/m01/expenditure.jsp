...
<script src="js/m01/expenditure.js"></script>
<style type="text/css">
	@page {
      ...
      <table class="m">
        <thead>
          <tr>
            ...
            <th style="width: 8%;">總價</th>
            <th style="width: 7%;">申請本部補助</th>
            <th style="width: 8%;">說明</th>
          </tr>
        </thead>
        <tbody>
        	<c:choose><c:when test="${not empty expenditure}">
