...
<script type="text/javascript" src="js/q04/q04.js"></script>
</head>
...
<body>
  ...
  <div id="main">
    ...
    <div id="content">
      ...
      <c:if test="${functionPermission2.indexOf('Q04')!=-1 }">
      <!------------------- search ------------------->
        <form action="q04" method="post" id="searchForm">
		<div id="search_bar">
    ...
    <c:if test="${functionPermission2.indexOf('Q04')==-1 }"><p>無此權限</p></c:if>
